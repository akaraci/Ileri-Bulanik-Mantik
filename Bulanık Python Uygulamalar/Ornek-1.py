...
ax3.plot(var_fiyat,rule1,'r', linestyle='--', linewidth=5, label='Rule-1')
ax3.plot(var_fiyat,rule2, 'b', linestyle='-.', linewidth=5, label='Rule-2')
ax3.plot(var_fiyat,rule3, 'g', linestyle=':', linewidth=5, label='Rule-3')
